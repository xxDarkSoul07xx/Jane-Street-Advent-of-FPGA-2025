Welcome to my solution for part 1 of this problem. You can see my RTL design in SystemVerilog in the [rtl](./rtl) folder and its testbench in the tb folder.
...
Download the sequential.sv, sequential_tb.sv, and input.txt
Open Vivado, make a new project with any board/part (won't matter for simulation), and make sequential.sv a design source. Make sequential_tb.sv and input.txt simulations sources.
Run simulation. You can look at the waveform and the log.
